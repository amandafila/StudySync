...
<head>
    ...
    <link rel="stylesheet" href="../assets/styles/menu_faculdade.css">
...
<body>
    <header> 
        ...
        <div class="header_div_faculdade">
            <a class="header_faculdade" href="#">Faculdade</a>
        </div>
    </header>

    <div class="div_botoes">
        <div class="div_primeira_linha">
            <a href="#"  class="botao_funcao">Criar grupo</a>
